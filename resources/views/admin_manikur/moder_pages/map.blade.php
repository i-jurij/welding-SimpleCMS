...
@section("content")
    ...
    @else
        <div class="content" >
            ...
            @csrf
                <p class="my-1">Вставьте ссылку на iframe карты из Google Map, Яндекс карт, OpenStreetMap. </p>
                <p class="my-1">Javascript API карт здесь НЕ подключится. Это нужно сделать самостоятельно. </p>
                <p class="my-1">
                ...
                <p class="my-1">Или добавьте изображение карты</p>
